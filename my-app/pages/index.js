...
//   const [balanceOfCryptoDevTokens, setBalanceOfCryptoDevsTOken] =
//     useState(zero);
...
//         var amount = 0;
//         for (i = 0; i < balance; i++) {
//           const tokenIds = await nftContract.tokenOfOwnerByIndex(address, i);
//           const claimedTokens = await tokenContract.tokenIdsClaimed(tokenIds);
//           if (!claimedTokens) {
//             amount += 1;
//           }
//         }
